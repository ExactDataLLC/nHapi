...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		...
		public virtual ImpNote ImpNote
		{
			get
			{
				return this.impNote;
		...
		/// </param>
		/// <exception cref="PropertyVetoException"> </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void setEncodings(int index, Encoding encodings) throws java.beans.PropertyVetoException
